...
# Code by Keelin Haynes (hayneskd@miamioh.edu, Masters Student in Geography, Miami University, Oxford, OH USA
# 
...
#
#Link to original script: https://github.com/keelindhaynes/IraqViolenceVisualization-R-
#
#
